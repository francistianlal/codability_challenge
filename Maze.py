# -*- coding: utf-8 -*-
"""
Created on Thu May 21 17:07:28 2020
...
class testsolution(unittest.TestCase):
    def test_1(self):
        (N,A,B,C,D) = (1,2,1,3,4)
        self.assertEqual(solution(N,A,B,C,D), 8)
       
    def test_2(self):
        (N,A,B,C,D) = (2,2,5,6,6)
        self.assertEqual(solution(N,A,B,C,D), 7)
        
    def test_3(self):
        (N,A,B,C,D) = (3,6,6,10,13)
        self.assertEqual(solution(N,A,B,C,D), 39)
